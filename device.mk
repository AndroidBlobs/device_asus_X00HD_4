...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/system/android.software.picture_in_picture.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/android.software.picture_in_picture.xml \
...
# Inherit vendor
$(call inherit-product, vendor/asus/X00HD_4/X00HD_4-vendor.mk)